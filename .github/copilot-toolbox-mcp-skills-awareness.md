...
_Generated: 2026-05-25T17:06:21.948Z_
...
Workspace `mcp.json` _(folder: hela-pesa)_

- **c:\Users\Coisa\Pictures\hela-pesa\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Coisa\AppData\Roaming\Code\User\mcp.json** — _File exists — servers defined_
